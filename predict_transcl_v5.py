...
# -*- coding: utf-8 -*-
"""
Trans-CL v5 推理脚本 (三分类, 40D特征)
==============================
用法:
  python predict_transcl_v5.py --data-path valid_input.parquet --model-path models/transcl_v5/best.pth --encoder-path models/transcl_v5/encoder.pkl --output-path res.csv
"""
...
def main():
    ...
    from train_transcl_v5 import TransCLContrastiveModel, evaluate_metrics, print_metrics
