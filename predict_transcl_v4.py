...
# -*- coding: utf-8 -*-
"""
Trans-CL v4 推理脚本 (三分类)
==============================
用法:
  python predict_transcl_v4.py --data-path valid_input.parquet --model-path models/transcl_v4/best.pth --encoder-path models/transcl_v4/encoder.pkl --output-path res.csv
"""
